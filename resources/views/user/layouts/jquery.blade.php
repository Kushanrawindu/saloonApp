<!-- js -->
<script type="text/javascript" src="{{asset('user/js/jquery-2.2.3.min.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/bootstrap.js')}}"></script> <!-- Necessary-JavaScript-File-For-Bootstrap --> 
<!-- //js -->
